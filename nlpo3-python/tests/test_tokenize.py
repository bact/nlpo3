...
class TestTokenizePackage(unittest.TestCase):
    ...
    def test_segment(self):
        ...
        self.assertEqual(segment(None, DICT_NAME), [])
        self.assertEqual(segment("", DICT_NAME), [])
        self.assertEqual(segment(" ", DICT_NAME), [" "])
        self.assertEqual(
            segment("ไข่คน2021", DICT_NAME),
            ["ไข่", "คน", "2021"],
        )
        self.assertIn(
            "ค่าจ้าง",  # in dict there is "ค่า" and "ค่าจ้าง"
            segment(
        ...
        self.assertIsInstance(segment(self.TEXT_1, DICT_NAME), List)
        self.assertIsInstance(segment(self.TEXT_2, DICT_NAME), List)
        self.assertIsInstance(segment(self.LONG_TEXT, DICT_NAME), List)
