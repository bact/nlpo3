...
- [ ] Human-readable name of the main lib is "nlpO3" (with capital O and no hyphen).
- [ ] Main package names is "nlpo3" (lowercase, no hyphen)
- [ ] README and CHANGELOG files target average library users.
- [ ] Internal architecture details, heuristics, and trade-offs are
      documented in docs/implementation.md
- [ ] Design and proposal for future improvements are documentd in
      docs/design.md
